  ...
  return (
    <nav className="app-nav">
      ...
      <div className="app-nav-bottom">
        {/* Take Intend with you */}
        <div className="app-nav-channels">
          <p className="app-nav-channels-heading">Take Intend with you</p>
          <div className="app-nav-channels-row">
            <a
              href="https://t.me/intend_auto_bot"
              target="_blank"
              rel="noreferrer"
              className="app-nav-channel-pill app-nav-channel-pill--active"
            ...
            <button
              className="app-nav-channel-pill app-nav-channel-pill--soon"
              disabled
        ...
        {/* Settings + Profile icon bar */}
        <div className="app-nav-footer-row">
          <Link
            href="/app/settings"
            className={`app-nav-footer-btn${pathname.startsWith('/app/settings') ? ' app-nav-footer-btn--active' : ''}`}
            title="Settings"
          >
            <SettingsIcon />
            <span>Settings</span>
          ...
          <Link
            href="/app/profile"
            className={`app-nav-footer-btn${pathname.startsWith('/app/profile') ? ' app-nav-footer-btn--active' : ''}`}
            title="Profile"
          >
            <ProfileIcon />
            <span>Profile</span>
